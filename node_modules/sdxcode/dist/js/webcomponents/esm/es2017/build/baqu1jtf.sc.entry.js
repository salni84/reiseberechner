...
class MenuFlyoutList {
    ...
    static get style() { return "*.sc-sdx-menu-flyout-list, .sc-sdx-menu-flyout-list:after, .sc-sdx-menu-flyout-list:before, .sc-sdx-menu-flyout-list-h{-webkit-box-sizing:border-box;box-sizing:border-box}.sc-sdx-menu-flyout-list-h{display:block;position:absolute;top:0;left:0;z-index:60000;-webkit-box-shadow:0 0 4px 0 rgba(0,0,0,.2);box-shadow:0 0 4px 0 rgba(0,0,0,.2);width:254px}"; }
}
