...
class Accordion {
    ...
    static get style() { return "*.sc-sdx-accordion, .sc-sdx-accordion:after, .sc-sdx-accordion:before, .sc-sdx-accordion-h{-webkit-box-sizing:border-box;box-sizing:border-box}.sc-sdx-accordion-h{display:block;border-bottom:1px solid #d6d6d6}"; }
}
