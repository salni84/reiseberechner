...
<section class="live-example">
  <div class="section-inner">
    <div class="resizerExample">
      <img class="img-responsive img-retina margin-bottom-4" src="/theme-build-v1.32.0/img/design/typo/resources-type-resizer@2x-1.jpg">
          ...
          <div class="resizer sc-resizer" init="auto" sizes="sizes">
            ...
            <div class="resizer__container">
              ...
              <div class="resizer__innercontainer">
                ...
                <iframe style="min-height: 1000px;" src="/theme-build-v1.32.0/img/design/typo/typography-6.html" scrolling="no" frameborder="0"></iframe>
              </div>
            </div>
          </div>
          <datalist id="sizes">
...
<div class="content-design">
  ...
  <div class="row">
      <div class="col-xs-12 col-lg-12">
        <img class="img-responsive" src="/theme-build-v1.32.0/img/design/typo/type-the-sans@2x.jpg">
  ...
  <div class="row">
      <div class="col-xs-12 col-lg-12">
        <img class="img-responsive" src="/theme-build-v1.32.0/img/design/typo/type-the-serif@2x.jpg">
  ...
  <div class="row">
      <div class="col-xs-12 col-lg-12">
        <img class="img-responsive" src="/theme-build-v1.32.0/img/design/typo/type-and-color-accessibility@2x.jpg">
        ...
        <div class="container">
          <div class="slider-wrapper">
            ...
            <div class="slider-gallery-off" data-max-height="85">
              <div class="slide">
                <img class="img-responsive" style="margin: 0 auto;" src="/theme-build-v1.32.0/img/design/typo/type-and-color-accessibility@2x.jpg">
              </div>
            </div>
  ...
  <div class="row">
      <div class="col-xs-12 col-lg-12">
        <img class="img-responsive" src="/theme-build-v1.32.0/img/design/typo/type-color-light@2x.jpg">
  ...
  <div class="row">
      <div class="col-xs-12 col-lg-12">
        <img class="img-responsive"  src="/theme-build-v1.32.0/img/design/typo/type-color-dark@2x.jpg">
  ...
  <div class="row">
      <div class="col-xs-12 col-lg-12">
        <img class="img-responsive" src="/theme-build-v1.32.0/img/design/typo/type-padding@2x.jpg">
  ...
  <div class="row">
      <div class="col-xs-12 col-lg-12">
        <img class="img-responsive" src="/theme-build-v1.32.0/img/design/typo/type-letter-spacing-large@2x.jpg">
  ...
  <div class="row">
      <div class="col-xs-12 col-lg-12">
        <img class="img-responsive" src="/theme-build-v1.32.0/img/design/typo/type-letter-spacing-small@2x.jpg">
        <span class="fig-caption">Letter-spacing</span>
      </div>
  </div>
</div>
...
.integer.text-d1 .period, .integer.text-d2 .period, .integer.text-d3 .period {
  margin-top: 0.55em;
}
