...
class MenuFlyout {
    ...
    static get style() { return "*.sc-sdx-menu-flyout, .sc-sdx-menu-flyout:after, .sc-sdx-menu-flyout:before, .sc-sdx-menu-flyout-h{-webkit-box-sizing:border-box;box-sizing:border-box}.sc-sdx-menu-flyout-h{position:relative;display:inline-block}"; }
}
